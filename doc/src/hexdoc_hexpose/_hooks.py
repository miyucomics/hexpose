...
import hexdoc_hexpose

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HexposePlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexposeModPlugin(branch=branch)


class HexposeModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexpose"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexpose, "_templates"
